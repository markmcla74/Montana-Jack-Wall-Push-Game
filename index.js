 ...
 //alert("If you see this, the script is loading!");
    ...
    const cpuBrain = {
      ...
      posPlus1: [
        // CPU Losing: More aggressive, but patient when Player 1 is broke.
        // P1 Energy: 0,      1,      2,      3,      4,      5,      6+
        [990000, 990000, 990000, 990000, 990000, 990000, 990000], // CPU 0
        [990000, 990000, 990000, 950400, 900900, 801900, 702900], // CPU 1
        [990000, 990000, 247500, 801900, 702900, 603900, 405900], // CPU 2: 75% Push vs P1 Energy 2
        [900900, 851400, 801900, 603900, 405900, 207900, 108900], // CPU 3
        [990000, 201069, 202059, 153054, 104049, 056034, 019008], // CPU 4: 100% Rest vs P1 Energy 0
        [050193, 050193, 050193, 050589, 051084, 052074, 014058], // CPU 5
      ...
      posZero: [
        // Neutral Ground
        [990000, 990000, 990000, 990000, 990000, 990000, 990000], // CPU 0
        [990000, 990000, 990000, 990000, 950400, 900900, 801900], // CPU 1
        [990000, 990000, 950400, 900900, 801900, 702900, 603900], // CPU 2
        [900900, 851400, 801900, 702900, 504900, 306900, 108900], // CPU 3
        [300564, 301059, 251559, 202059, 153054, 104049, 059400], // CPU 4
        [150183, 150183, 100188, 100584, 051084, 052074, 019800], // CPU 5
        [000099, 000099, 000099, 000099, 000099, 000099, 000099]  // CPU 6+
      ],

      posMinus1: [
        // CPU Winning: Strategic Pushing and Gatekeeping
        // P1 Energy: 0,      1,      2,      3,      4,      5,      6+
        [990000, 990000, 990000, 990000, 990000, 990000, 990000], // CPU 0
        [990000, 990000, 801900, 702900, 900900, 108900, 059400], // CPU 1: 90% Rest vs P1 Energy 4
        [009900, 950400, 851400, 405900, 306900, 207900, 108900], // CPU 2: 100% Push vs P1 Energy 0
        [950400, 900900, 851400, 801900, 702900, 603900, 405900], // CPU 3
